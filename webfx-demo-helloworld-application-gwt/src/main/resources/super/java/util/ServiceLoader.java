...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.platform.resource.spi.impl.gwt.GwtResourceBundle": return new ServiceLoader<S>(webfx.demo.helloworld.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(dev.webfx.demo.helloworld.HelloWorldApplication::new);
